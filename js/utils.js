...
function generateRandomColor() {
    var colors = ['#e94560', '#0f3460', '#d4af37', '#28a745', '#17a2b8', '#6f42c1', '#fd7e14', '#20c997'];
...
function showLoading(message) {
    ...
    loader.style.cssText = 'position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.7);z-index:2000;display:flex;flex-direction:column;align-items:center;justify-content:center;';
    loader.innerHTML = '<div style="width:50px;height:50px;border:4px solid rgba(255,255,255,0.3);border-top:4px solid #d4af37;border-radius:50%;animation:spin 1s linear infinite;"></div><p style="color:#fff;margin-top:20px;">' + message + '</p>';
